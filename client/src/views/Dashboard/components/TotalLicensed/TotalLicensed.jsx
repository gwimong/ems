...
const TotalLicensed = props => {
  ...
  useEffect(() => {
    if (licensedList != null) {
      setTotalCount(licensedList.length);
      setIncreaseValue(licensedList.filter(item => {
        ...
        >
          ...
          <Grid item>
            <Avatar className={classes.avatar}>
              <LibraryBookIcon className={classes.icon} />
            </Avatar>
          </Grid>
        </Grid>
...
TotalLicensed.propTypes = {
  className: PropTypes.string
};

export default TotalLicensed;
